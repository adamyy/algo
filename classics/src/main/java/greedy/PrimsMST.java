 ...
 * So, at every step of Prim’s algorithm, we find a cut (of two sets,
 * one contains the vertices already included in MST and other contains rest of the vertices),
